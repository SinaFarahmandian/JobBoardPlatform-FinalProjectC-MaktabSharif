...
public class AuthResultDto
{
    ...
    public static AuthResultDto SuccessWithToken(string token, string refreshToken, string fullName, string email, string role)
        => new() { Succeeded = true, Token = token, RefreshToken = refreshToken, FullName = fullName, Email = email, Role = role };
}